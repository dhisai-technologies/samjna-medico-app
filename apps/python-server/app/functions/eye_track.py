...
class Facetrack(BlinkDetector):
    ...
    def predict(self,img):
        ...
        if self.results.multi_face_landmarks:
            ...
            cv2.putText(img, f'Total Blinks: {self.list_blinks[0]}', (30, 150), cv2.FONT_HERSHEY_COMPLEX, 0.6, (0, 255, 0), 1)
            ...
            if self.list_blinks[1]:
                ...
                last_blink_duration = self.list_blinks[1][-1]
...
def process_video(fc,frames,fps):
    frame_number = 0
    preds=[]
    ...
    for frame in frames:
        ...
        data=[timestamp,frame_number,fc.TOTAL_BLINKS,fc.avg_blink_duration]
        preds.append(data)
        frame_number += 1
    return preds